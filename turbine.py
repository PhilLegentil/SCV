...
def table_3(l_aube, pitch_dia, p_out, m_dot):
    ...
    y = np.array([128,150,175,200,250,300,350,400,450,500,550,600,650,700,800,900,1000,1100, 1200,1300,1400])
...
# p_1 = 12500
# p_2 = 1000
# h_1 = H2O.h(T=750, p=p_1)
# p_di = 1044
#
# mdot = np.linspace(50, 300, 50)
# rend = turbine_3600_HP(500, mdot, 1, h_1, p_1, p_2, p_di)
#
# opt = td.point_optimal(mdot, rend, 100,1000)
# print('opt', opt)
#
# # plt.plot(mdot, rend)
# # plt.show()
#
# h_2 = H2O.h(T=800, p=1000)
# rend = turbine_3600_int(mdot,2000,1000,h_2)
# print(rend)

# l_aube = 1093
# p_di = 3500
#
# pertes = table_3(l_aube, p_di, 10, mdot)
#
# plt.plot(mdot, pertes)
# plt.show()